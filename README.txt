...
bitnami-mampstack-7.3.16-2-osx-x86-installer.dmg 
...
a regular user, or /opt/mampstack-7.3.16-2, if you are running the 
...
/Applications/mampstack-7.3.16-2 and that you use port 8080 for Apache and 3306 for MySQL.
